import{j as a}from"./vendor-motion-D2W_XPnt.js";import{u as p,d as c,r as i}from"./vendor-react-BCWXX3kQ.js";import{u as g}from"./main-C6_JiveD.js";/* empty css              */import"./vendor-firebase-DGwgGbjK.js";const x=3e3;function v(){var r;const n=p(),s=c(),{user:e,loading:t}=g(),[o,d]=i.useState(!1),m=((r=s.state)==null?void 0:r.from)==="login";return i.useEffect(()=>{document.title="Loading — For Jessa Mae"},[]),i.useEffect(()=>{const l=setTimeout(()=>d(!0),x);return()=>clearTimeout(l)},[]),i.useEffect(()=>{!o||t||n(e?"/admin/dashboard":"/admin/login",{replace:!0})},[o,t,e,n]),a.jsxs(a.Fragment,{children:[a.jsx("style",{children:`
        .admin-main {
          min-height: 100vh;
          width: 100%;
          display: flex;
      ...
      `}),a.jsxs("div",{className:"admin-main",children:[a.jsx("span",{className:"admin-main__blob admin-main__blob--1"}),a.jsx("span",{className:"admin-main__blob admin-main__blob--2"}),a.jsx("span",{className:"admin-main__blob admin-main__blob--3"}),a.jsxs("div",{className:"admin-main__card",children:[a.jsxs("span",{className:"admin-main__chip",children:[a.jsx("span",{className:"pulse"}),"Private"]}),a.jsx("div",{className:"admin-main__seal-wrap",children:a.jsx("span",{className:"admin-main__seal-mark",children:"J"})}),a.jsxs("h1",{className:"admin-main__title",children:["For ",a.jsx("span",{className:"script",children:"Jessa Mae"})]}),a.jsx("p",{className:"admin-main__sub",children:m?"Signed in — unlocking the archive…":"Warming the wax seal, please wait…"}),a.jsx("div",{className:"admin-main__loader","aria-hidden":"true"}),a.jsxs("div",{className:"admin-main__loading-text",children:["Loading",a.jsx("span",{className:"dot",children:"."}),a.jsx("span",{className:"dot",children:"."}),a.jsx("span",{className:"dot",children:"."})]})]})]})]})}export{v as default};
